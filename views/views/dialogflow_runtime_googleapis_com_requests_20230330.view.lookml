# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330"
- view: dialogflow_runtime_googleapis_com_requests_20230330
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: |
      `dialogflowagentlogs.dialogflow_runtime_googleapis_com_requests_20230330`
...
# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Responsemessages"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__responsemessages
...
# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Responsemessages Text Text"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__responsemessages__text__text
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Responsemessages Text Text" in Explore.

  - dimension: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__responsemessages__text__text
    type: string
    sql: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__responsemessages__text__text


# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Triggered Transition Names"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__triggered_transition_names
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Triggered Transition Names" in Explore.

  - dimension: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__triggered_transition_names
    type: string
    sql: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__triggered_transition_names


# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Execution Sequence"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence
...
# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Alternative Matched Intents"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__alternative_matched_intents
  drill_fields: [id]
...
# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Execution Sequence Step 2 Functionexecution Responses"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses
...
# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Execution Sequence Step 2 Functionexecution Responses Text Text"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses__text__text
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Execution Sequence Step 2 Functionexecution Responses Text Text" in Explore.

  - dimension: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses__text__text
    type: string
    sql: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses__text__text


# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Execution Sequence Step 2 Functionexecution Responses Text Redactedtext"
- view: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses__text__redactedtext
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dialogflow Runtime Googleapis Com Requests 20230330 JSON Payload Queryresult Diagnosticinfo Execution Sequence Step 2 Functionexecution Responses Text Redactedtext" in Explore.

  - dimension: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses__text__redactedtext
    type: string
    sql: dialogflow_runtime_googleapis_com_requests_20230330__json_payload__queryresult__diagnosticinfo__execution_sequence__step_2__functionexecution__responses__text__redactedtext
