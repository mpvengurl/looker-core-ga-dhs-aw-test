# The name of this view in Looker is "Dialogflow Googleapis Com Incoming Call 20230330"
- view: dialogflow_googleapis_com_incoming_call_20230330
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: |
      `dialogflowagentlogs.dialogflow_googleapis_com_incoming_call_20230330`
  ...
  - dimension: json_payload__conversationprofile
    ...
    group_label: JSON Payload
    field_group_variant: Conversationprofile
  ...
  - dimension: json_payload__phonenumber
    ...
    group_label: JSON Payload
    field_group_variant: Phonenumber
  ...
  - dimension: json_payload__servicename
    ...
    group_label: JSON Payload
    field_group_variant: Servicename
