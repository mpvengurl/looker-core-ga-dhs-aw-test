# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502"
- view: cloudaudit_googleapis_com_policy_20230502
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: |
      `dialogflowagentlogs.cloudaudit_googleapis_com_policy_20230502`
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Authorization Info"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__authorization_info
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Resource Location Current Locations"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__resource_location__current_locations
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Resource Location Current Locations" in Explore.

  - dimension: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__resource_location__current_locations
    type: string
    sql: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__resource_location__current_locations


# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Resource Location Original Locations"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__resource_location__original_locations
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Resource Location Original Locations" in Explore.

  - dimension: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__resource_location__original_locations
    type: string
    sql: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__resource_location__original_locations


# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Request Metadata Request Attributes Headers"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__headers
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Authorization Info Resource Attributes Labels"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__authorization_info__resource_attributes__labels
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Request Metadata Request Attributes Auth Audiences"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__auth__audiences
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Request Metadata Request Attributes Auth Audiences" in Explore.

  - dimension: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__auth__audiences
    type: string
    sql: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__auth__audiences


# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Request Metadata Destination Attributes Labels"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__destination_attributes__labels
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Request Metadata Request Attributes Auth Access Levels"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__auth__access_levels
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Request Metadata Request Attributes Auth Access Levels" in Explore.

  - dimension: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__auth__access_levels
    type: string
    sql: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__request_metadata__request_attributes__auth__access_levels


# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Authorization Info Resource Attributes Annotations"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__authorization_info__resource_attributes__annotations
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Policy Violation Info Org Policy Violation Info Resource Tags"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__policy_violation_info__org_policy_violation_info__resource_tags
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Authentication Info Service Account Delegation Info"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__authentication_info__service_account_delegation_info
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230502 Protopayload Auditlog Policy Violation Info Org Policy Violation Info Violation Info"
- view: cloudaudit_googleapis_com_policy_20230502__protopayload_auditlog__policy_violation_info__org_policy_violation_info__violation_info
