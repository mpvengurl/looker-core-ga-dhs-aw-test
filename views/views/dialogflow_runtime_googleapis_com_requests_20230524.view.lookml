# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230524"
- view: dialogflow_runtime_googleapis_com_requests_20230524
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: |
      `dialogflowagentlogs.dialogflow_runtime_googleapis_com_requests_20230524`
...
# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230524 JSON Payload Queryresult Diagnosticinfo Triggered Transition Names"
- view: dialogflow_runtime_googleapis_com_requests_20230524__json_payload__queryresult__diagnosticinfo__triggered_transition_names
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dialogflow Runtime Googleapis Com Requests 20230524 JSON Payload Queryresult Diagnosticinfo Triggered Transition Names" in Explore.

  - dimension: dialogflow_runtime_googleapis_com_requests_20230524__json_payload__queryresult__diagnosticinfo__triggered_transition_names
    type: string
    sql: dialogflow_runtime_googleapis_com_requests_20230524__json_payload__queryresult__diagnosticinfo__triggered_transition_names


# The name of this view in Looker is "Dialogflow Runtime Googleapis Com Requests 20230524 JSON Payload Queryresult Diagnosticinfo Execution Sequence"
- view: dialogflow_runtime_googleapis_com_requests_20230524__json_payload__queryresult__diagnosticinfo__execution_sequence
