# The name of this view in Looker is "Dlpoutput"
- view: dlpoutput
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: |
      `dialogflowagentlogs.dlp-output`
...
# The name of this view in Looker is "Dlp-output Table Profile Resource Labels"
- view: dlp-output__table_profile__resource_labels
...
# The name of this view in Looker is "Dlp-output Column Profile Other Matches"
- view: dlp-output__column_profile__other_matches
...
# The name of this view in Looker is "Dlp-output Table Profile Other Info Types"
- view: dlp-output__table_profile__other_info_types
...
# The name of this view in Looker is "Dlp-output Table Profile Predicted Info Types"
- view: dlp-output__table_profile__predicted_info_types
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Info Types"
- view: dlp-output__table_profile__config_snapshot__inspect_config__info_types
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Content Options"
- view: dlp-output__table_profile__config_snapshot__inspect_config__content_options
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Content Options" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__content_options
    type: string
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__content_options`


# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Data Profile Job Inspect Templates"
- view: dlp-output__table_profile__config_snapshot__data_profile_job__inspect_templates
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Data Profile Job Inspect Templates" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__data_profile_job__inspect_templates
    type: string
    sql: |
      `dlp-output__table_profile__config_snapshot__data_profile_job__inspect_templates`


# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Info Types"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__info_types
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Custom Info Types"
- view: dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Custom Info Types Regex Group Indexes"
- view: dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Custom Info Types Regex Group Indexes" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes
    type: number
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes`
  ...
  - measure: total_dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes
    type: sum
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes}
  - measure: average_dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes
    type: average
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__regex__group_indexes}

# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Rules"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Min Likelihood per Info Type"
- view: dlp-output__table_profile__config_snapshot__inspect_config__min_likelihood_per_info_type
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Custom Info Types Dictionary Word List Words"
- view: dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__dictionary__word_list__words
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Custom Info Types Dictionary Word List Words" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__dictionary__word_list__words
    type: string
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__dictionary__word_list__words`


# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Limits Max Findings per Info Type"
- view: dlp-output__table_profile__config_snapshot__inspect_config__limits__max_findings_per_info_type
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Regex Group Indexes"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Regex Group Indexes" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes
    type: number
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes`
  ...
  - measure: total_dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes
    type: sum
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes}
  - measure: average_dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes
    type: average
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__regex__group_indexes}

# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Data Profile Job Data Profile Actions"
- view: dlp-output__table_profile__config_snapshot__data_profile_job__data_profile_actions
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Rules Hotword Rule Hotword Regex Group Indexes"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Rule Set Rules Hotword Rule Hotword Regex Group Indexes" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes
    type: number
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes`
  ...
  - measure: total_dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes
    type: sum
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes}
  - measure: average_dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes
    type: average
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__hotword_rule__hotword_regex__group_indexes}

# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Dictionary Word List Words"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__dictionary__word_list__words
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Dictionary Word List Words" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__dictionary__word_list__words
    type: string
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__dictionary__word_list__words`


# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Exclude Info Types Info Types"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_info_types__info_types
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Custom Info Types Detection Rules"
- view: dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules
...
# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Custom Info Types Detection Rules Hotword Rule Hotword Regex Group Indexes"
- view: dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Custom Info Types Detection Rules Hotword Rule Hotword Regex Group Indexes" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes
    type: number
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes`
  ...
  - measure: total_dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes
    type: sum
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes}
  - measure: average_dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes
    type: average
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__custom_info_types__detection_rules__hotword_rule__hotword_regex__group_indexes}

# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Exclude By Hotword Hotword Regex Group Indexes"
- view: dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Dlpoutput Table Profile Config Snapshot Inspect Config Rule Set Rules Exclusion Rule Exclude By Hotword Hotword Regex Group Indexes" in Explore.

  - dimension: dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes
    type: number
    sql: |
      `dlp-output__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes`
  ...
  - measure: total_dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes
    type: sum
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes}
  - measure: average_dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes
    type: average
    sql: ${dlpoutput__table_profile__config_snapshot__inspect_config__rule_set__rules__exclusion_rule__exclude_by_hotword__hotword_regex__group_indexes}

# The name of this view in Looker is "Dlp-output Table Profile Config Snapshot Data Profile Job Data Profile Actions Pub Sub Notification Pubsub Condition Expressions Conditions"
- view: dlp-output__table_profile__config_snapshot__data_profile_job__data_profile_actions__pub_sub_notification__pubsub_condition__expressions__conditions
