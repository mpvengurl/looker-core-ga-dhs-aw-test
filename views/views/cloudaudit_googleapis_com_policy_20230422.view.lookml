# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422"
- view: cloudaudit_googleapis_com_policy_20230422
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: |
      `dialogflowagentlogs.cloudaudit_googleapis_com_policy_20230422`
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Authorization Info"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Resource Location Current Locations"
- view: cloudaudit_googleapis_com_policy_20230422__protopayload_auditlog__resource_location__current_locations
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Resource Location Current Locations" in Explore.
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Resource Location Original Locations"
- view: cloudaudit_googleapis_com_policy_20230422__protopayload_auditlog__resource_location__original_locations
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Resource Location Original Locations" in Explore.
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Request Metadata Request Attributes Headers"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Authorization Info Resource Attributes Labels"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Request Metadata Request Attributes Auth Audiences"
- view: cloudaudit_googleapis_com_policy_20230422__protopayload_auditlog__request_metadata__request_attributes__auth__audiences
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Request Metadata Request Attributes Auth Audiences" in Explore.
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Request Metadata Destination Attributes Labels"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Request Metadata Request Attributes Auth Access Levels"
- view: cloudaudit_googleapis_com_policy_20230422__protopayload_auditlog__request_metadata__request_attributes__auth__access_levels
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Request Metadata Request Attributes Auth Access Levels" in Explore.
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Authorization Info Resource Attributes Annotations"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Policy Violation Info Org Policy Violation Info Resource Tags"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Authentication Info Service Account Delegation Info"
...
# The name of this view in Looker is "Cloudaudit Googleapis Com Policy 20230422 Protopayload Auditlog Policy Violation Info Org Policy Violation Info Violation Info"
